...
import (
	...
	"github.com/easysoft/gitfox/app/pipeline/logger"
	"github.com/easysoft/gitfox/pkg/util/common"
	"github.com/easysoft/gitfox/profiler"
...
func (c *command) run(*kingpin.ParseContext) error {
	...
	log.Info().
		...
		Str("revision", common.GitCommitHash).
		Str("build", common.BuildDate).
...
func SetupProfiler(config *types.Config) {
	...
	gitfoxProfiler, _ := profiler.New(profilerType)
	gitfoxProfiler.StartProfiling(config.Profiler.ServiceName, common.GetVersionWithHash())
}
