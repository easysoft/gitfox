...
import SpaceArtifactList from 'pages/Artifacts/SpaceArtifactList'
  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route path={routes.toCODESpaceArtifacts({ space: pathProps.space })} exact>
          <LayoutWithSideNav title={getString('pageTitle.artifacts')}>
            <SpaceArtifactList />
          </LayoutWithSideNav>
        </Route>
        <Route
        ...
        <Route path={routes.toCODESystem()}>
          <LayoutWithSideNav title={getString('pageTitle.users')}>
            <SystemProfile />
          </LayoutWithSideNav>
        </Route>
        ...
        {standalone && (
          <Route path={routes.toCODEPipelineEdit({ repoPath, pipeline: pathProps.pipeline })} exact>
            {
              location.href.includes('fullscreen=zentao')
                ? <AddUpdatePipeline hideHeader />
                : (
