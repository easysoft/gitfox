        ...
        <Layout.Horizontal padding={{ top: 'medium' }} spacing="xsmall">
          <Text>
            <StringSubstitute
              ...
              vars={{
                policy: <a href="#"> {getString('privacyPolicy')} </a>,
                terms: <a href="#"> {getString('termsOfUse')} </a>
              }}
            />
          </Text>
        </Layout.Horizontal>
        <Layout.Horizontal padding={{ top: 'medium' }} spacing="xsmall" flex={{ align: 'center-center' }}>
          <Text>
            <StringSubstitute
              str={getString('thankTeam')}
              vars={{
                gitness: <a href="https://github.com/harness/gitness"> Gitness </a>
              }}
            />
          </Text>
        </Layout.Horizontal>
