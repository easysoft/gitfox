    ...
    <Container className={css.main} padding="large">
      <Layout.Horizontal spacing="medium">
        ...
        <SplitButton
          ...
          {getPrCreationOptions().map(option => {
            return (
              <Menu.Item
                key={option.type}
...
export function getPrCreationOptions(): PRCreationOption[] {
  // eslint-disable-next-line react-hooks/rules-of-hooks
  const { getString } = useStrings()
  return [
    {
      type: PRCreationType.NORMAL,
      title: getString('createPullRequest'),
      desc: getString('pr.createDesc')
    },
    {
      type: PRCreationType.DRAFT,
      title: getString('pr.createDraftPR'),
      desc: getString('pr.CreateDraftPRDesc')
    }
  ]
}
