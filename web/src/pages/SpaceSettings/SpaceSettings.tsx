...
import SpaceAIList from 'pages/SpaceAIList/SpaceAIList'
...
export default function SpaceSettings() {
  ...
  const tabListArray = [
    {
      ...
      title: getString('spaceSetting.general'),
      panel: (
    ...
    {
      id: SettingsTab.ai,
      title: getString('spaceSetting.ai'),
      panel: <SpaceAIList activeTab={activeTab} space={space} currentPageScope={LabelsPageScope.SPACE} />
    }
    // {
  ...
  return (
    <Container className={css.main}>
      <Page.Header title={getString('spaceSetting.settings')} className="PageHeader--container PageHeader--standard" />
      <PageBody>
