...
import AISettings from 'pages/RepositorySettings/AISettings/AISettings'
...
export default function RepositorySettings() {
  ...
  const tabListArray = [
    ...
    },
    {
      id: SettingsTab.ai,
      title: 'AI',
      panel: <AISettings repoMetadata={repoMetadata} activeTab={activeTab} />
    },
    // {
    //   id: SettingsTab.advanced,
    //   title: getString('advanced'),
    //   panel: <AdvancedSettings repoMetadata={repoMetadata} activeTab={activeTab} />
    // },
