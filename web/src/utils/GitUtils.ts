...
export const CodeIcon = {
  ...
  GitfoxCopilot: 'harness-copilot' as IconName
}
...
export enum WebhookIndividualEvent {
  ...
  PR_REVIEWER_CREATED = 'pullreq_reviewer_created',
  PR_REVIEWER_DELETED = 'pullreq_reviewer_deleted',
...
export enum WebhookEventMap {
  ...
  PR_MERGED = 'PR merged',
  PR_REVIEWER_CREATED = 'PR Reviewer created',
  PR_REVIEWER_DELETED = 'PR Reviewer deleted',
...
export const eventMapping: Record<WebhookIndividualEvent, WebhookEventMap> = {
  ...
  [WebhookIndividualEvent.PR_REVIEWER_CREATED]: WebhookEventMap.PR_REVIEWER_CREATED,
  [WebhookIndividualEvent.PR_REVIEWER_DELETED]: WebhookEventMap.PR_REVIEWER_DELETED,
