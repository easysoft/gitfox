...
type TriggerActionName =
  | 'triggers.branchCreated'
  | 'triggers.branchUpdated'
  | 'triggers.pullreqCreated'
  | 'triggers.pullreqBranchUpdated'
  | 'triggers.pullreqReopened'
  | 'triggers.pullreqClosed'
  | 'triggers.pullreqMerged'
  | 'triggers.tagCreated'
  | 'triggers.tagUpdated'
...
const branchActions: TriggerAction[] = [
  { name: 'triggers.branchCreated', value: 'branch_created' },
  { name: 'triggers.branchUpdated', value: 'branch_updated' }
]

const pullRequestActions: TriggerAction[] = [
  { name: 'triggers.pullreqCreated', value: 'pullreq_created' },
  { name: 'triggers.pullreqBranchUpdated', value: 'pullreq_branch_updated' },
  { name: 'triggers.pullreqReopened', value: 'pullreq_reopened' },
  { name: 'triggers.pullreqClosed', value: 'pullreq_closed' },
  { name: 'triggers.pullreqMerged', value: 'pullreq_merged' }
]

const tagActions: TriggerAction[] = [
  { name: 'triggers.tagCreated', value: 'tag_created' },
  { name: 'triggers.tagUpdated', value: 'tag_updated' }
]
  ...
  return (
    <Layout.Horizontal
      ...
      <Layout.Vertical spacing={'small'}>
        ...
        <Text className={css.triggerDate}>{`${getString('pipelines.lastUpdate')}: ${new Date(lastUpdated).toLocaleDateString('en-US', {
