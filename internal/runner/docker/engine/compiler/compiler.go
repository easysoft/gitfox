...
func (c *Compiler) Compile(ctx context.Context, args runtime.CompilerArgs) runtime.Spec {
	...
	envs["GITFOX_WORKSPACE"] = full
	envs["GITFOX_WORKSPACE_BASE"] = base
	envs["GITFOX_WORKSPACE_PATH"] = path
...
var allowDockerPluginVolumes = os.Getenv("GITFOX_FLAG_ALLOW_DOCKER_PLUGIN_VOLUMES") == "true"
