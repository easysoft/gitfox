...
import (
	...
	"github.com/easysoft/gitfox/internal/runner/docker/internal/docker/errors"
	"github.com/easysoft/gitfox/internal/runner/docker/internal/docker/image"
	"github.com/easysoft/gitfox/internal/runner/docker/internal/docker/jsonmessage"
	"github.com/easysoft/gitfox/internal/runner/docker/internal/docker/stdcopy"
...
func (e *Docker) Run(ctx context.Context, spec *Spec, step *Step, output io.Writer) (*State, error) {
	...
	var allowDeferTailLog = os.Getenv("GITFOX_DEFER_TAIL_LOG") == "true"
