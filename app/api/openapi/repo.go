...
var queryParamStatisticsIncludeMergeRequest = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsIncludeMergeRequest,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("Include merge request statistics in the response."),
		Required:    ptr.Bool(false),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type:    ptrSchemaType(openapi3.SchemaTypeBoolean),
...
var queryParamStatisticsIncludePushRequest = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsIncludePushRequest,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("Include push request statistics in the response."),
		Required:    ptr.Bool(false),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type:    ptrSchemaType(openapi3.SchemaTypeBoolean),
...
var queryParamStatisticsIncludeReview = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsIncludeReview,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("Include review statistics in the response."),
		Required:    ptr.Bool(false),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type:    ptrSchemaType(openapi3.SchemaTypeBoolean),
...
var queryParamStatisticsPeriod = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsPeriod,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("period statistics in the response."),
		Required:    ptr.Bool(true),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type:    ptrSchemaType(openapi3.SchemaTypeString),
				Default: ptrptr(enum.PeriodSortOptionDefault.String()),
				Enum: []interface{}{
					ptr.String(enum.PeriodSortOptionDefault.String()),
					ptr.String(enum.PeriodSortOptionWeek.String()),
					ptr.String(enum.PeriodSortOptionMonth.String()),
					ptr.String(enum.PeriodSortOptionYear.String()),
				},
			},
		},
	},
...
var queryParamStatisticsIncludeCode = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsIncludeCode,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("Include code statistics in the response."),
		Required:    ptr.Bool(false),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type:    ptrSchemaType(openapi3.SchemaTypeBoolean),
...
var queryParamStatisticsBranch = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsBranch,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("query group by branch, default is all"),
		Required:    ptr.Bool(false),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type: ptrSchemaType(openapi3.SchemaTypeInteger),
...
var queryParamStatisticsBeginTime = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsBeginTime,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("bengin time statistics in the response."),
		Required:    ptr.Bool(true),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type: ptrSchemaType(openapi3.SchemaTypeString),
...
var queryParamStatisticsEndTime = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsEndTime,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("end time statistics in the response. default is now"),
		Required:    ptr.Bool(false),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type:    ptrSchemaType(openapi3.SchemaTypeString),
...
var queryParamStatisticsTop = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsTop,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("statistics top user in the response. only work user is empty"),
		Required:    ptr.Bool(false),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type:    ptrSchemaType(openapi3.SchemaTypeInteger),
...
var queryParamStatisticsUser = openapi3.ParameterOrRef{
	Parameter: &openapi3.Parameter{
		Name:        request.QueryParamStatisticsUser,
		In:          openapi3.ParameterInQuery,
		Description: ptr.String("statistics user (username or email) in the response."),
		Required:    ptr.Bool(false),
		Schema: &openapi3.SchemaOrRef{
			Schema: &openapi3.Schema{
				Type:    ptrSchemaType(openapi3.SchemaTypeString),
...
func repoOperations(reflector *openapi3.Reflector) {
	...
	listRepos := openapi3.Operation{}
	listRepos.WithTags("repository")
	listRepos.WithMapOfAnything(map[string]interface{}{"operationId": "listAllRepos"})
	listRepos.WithParameters(queryParameterQueryRepo, queryParameterSortRepo, queryParameterOrder,
		QueryParameterPage, QueryParameterLimit, queryParameterRecursive)
	_ = reflector.SetRequest(&listRepos, new(listRepositoryRequest), http.MethodGet)
	_ = reflector.SetJSONResponse(&listRepos, []types.Repository{}, http.StatusOK)
	_ = reflector.SetJSONResponse(&listRepos, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&listRepos, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&listRepos, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&listRepos, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodGet, "/repos", listRepos)
	...
	opRemove := openapi3.Operation{}
	opRemove.WithTags("repository")
	opRemove.WithMapOfAnything(map[string]interface{}{"operationId": "removeRepository"})
	_ = reflector.SetRequest(&opRemove, new(repoRequest), http.MethodPost)
	_ = reflector.SetJSONResponse(&opRemove, new(repo.HardDeleteResponse), http.StatusNoContent)
	_ = reflector.SetJSONResponse(&opRemove, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opRemove, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opRemove, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opRemove, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodPost, "/repos/{repo_ref}/remove", opRemove)

	opSync := openapi3.Operation{}
	opSync.WithTags("repository")
	opSync.WithMapOfAnything(map[string]interface{}{"operationId": "syncRepository"})
	_ = reflector.SetRequest(&opSync, new(repoRequest), http.MethodPost)
	_ = reflector.SetJSONResponse(&opSync, nil, http.StatusNoContent)
	_ = reflector.SetJSONResponse(&opSync, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opSync, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opSync, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opSync, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodPost, "/repos/{repo_ref}/sync", opSync)
	...
	opListCommits.WithParameters(queryParameterGitRef, queryParameterAfterCommits, queryParameterPath,
		queryParameterSince, queryParameterUntil, queryParameterCommitter, queryParameterAuthor,
	...
	opSettingsAIUpdate := openapi3.Operation{}
	opSettingsAIUpdate.WithTags("repository")
	opSettingsAIUpdate.WithMapOfAnything(
		map[string]interface{}{"operationId": "updateAISettings"})
	_ = reflector.SetRequest(
		&opSettingsAIUpdate, new(securitySettingsRequest), http.MethodPatch)
	_ = reflector.SetJSONResponse(&opSettingsAIUpdate, new(reposettings.AISettings), http.StatusOK)
	_ = reflector.SetJSONResponse(&opSettingsAIUpdate, new(usererror.Error), http.StatusBadRequest)
	_ = reflector.SetJSONResponse(&opSettingsAIUpdate, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opSettingsAIUpdate, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opSettingsAIUpdate, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opSettingsAIUpdate, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(
		http.MethodPatch, "/repos/{repo_ref}/settings/ai", opSettingsAIUpdate)

	opSettingsAIFind := openapi3.Operation{}
	opSettingsAIFind.WithTags("repository")
	opSettingsAIFind.WithMapOfAnything(
		map[string]interface{}{"operationId": "findSecuritySettings"})
	_ = reflector.SetRequest(&opSettingsAIFind, new(repoRequest), http.MethodGet)
	_ = reflector.SetJSONResponse(&opSettingsAIFind, new(reposettings.AISettings), http.StatusOK)
	_ = reflector.SetJSONResponse(&opSettingsAIFind, new(usererror.Error), http.StatusBadRequest)
	_ = reflector.SetJSONResponse(&opSettingsAIFind, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opSettingsAIFind, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opSettingsAIFind, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opSettingsAIFind, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(
		http.MethodGet, "/repos/{repo_ref}/settings/ai", opSettingsAIFind)
	...
	opStatistics := openapi3.Operation{}
	opStatistics.WithTags("repository")
	opStatistics.WithMapOfAnything(
		map[string]interface{}{"operationId": "statistics"})
	opStatistics.WithParameters(
		// queryParamStatisticsIncludeMergeRequest,
		// queryParamStatisticsIncludePushRequest,
		// queryParamStatisticsIncludeReview,
		// queryParamStatisticsIncludeCode,
		// queryParamStatisticsPeriod,
		queryParamStatisticsBranch,
		queryParamStatisticsBeginTime,
		queryParamStatisticsEndTime,
		// queryParamStatisticsTop,
		queryParamStatisticsUser,
	)
	_ = reflector.SetRequest(&opStatistics, new(repoRequest), http.MethodGet)
	_ = reflector.SetJSONResponse(&opStatistics, new(types.RepositoryStatistics), http.StatusOK)
	_ = reflector.SetJSONResponse(&opStatistics, new(usererror.Error), http.StatusBadRequest)
	_ = reflector.SetJSONResponse(&opStatistics, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opStatistics, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opStatistics, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opStatistics, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodGet, "/repos/{repo_ref}/statistics", opStatistics)
