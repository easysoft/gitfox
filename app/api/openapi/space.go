...
type spaceAICreateRequest struct {
	spaceRequest
	space.AiConfigCreateInput
}

type spaceAIRequest struct {
	spaceRequest
	ID string `path:"ai_id"`
}

type spaceAIUpdateRequest struct {
	spaceAIRequest
	space.AiConfigUpdateInput
}
...
func spaceOperations(reflector *openapi3.Reflector) {
	opRootSpaces := openapi3.Operation{}
	opRootSpaces.WithTags("space")
	opRootSpaces.WithMapOfAnything(map[string]interface{}{"operationId": "listRootSpaces"})
	opRootSpaces.WithParameters(queryParameterQuerySpace, queryParameterSortSpace, queryParameterOrder,
		QueryParameterPage, QueryParameterLimit)
	_ = reflector.SetRequest(&opRootSpaces, new(rootSpaceRequest), http.MethodGet)
	_ = reflector.SetJSONResponse(&opRootSpaces, []types.Space{}, http.StatusOK)
	_ = reflector.SetJSONResponse(&opRootSpaces, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opRootSpaces, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opRootSpaces, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opRootSpaces, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodGet, "/spaces", opRootSpaces)
	...
	opAIListConfigs := openapi3.Operation{}
	opAIListConfigs.WithTags("ai")
	opAIListConfigs.WithSummary("获取AI配置列表")
	opAIListConfigs.WithMapOfAnything(
		map[string]interface{}{"operationId": "listSpaceAIConfigs"})
	_ = reflector.SetRequest(&opAIListConfigs, new(spaceRequest), http.MethodGet)
	_ = reflector.SetJSONResponse(&opAIListConfigs, new([]*types.AIConfig), http.StatusOK)
	_ = reflector.SetJSONResponse(&opAIListConfigs, new(usererror.Error), http.StatusBadRequest)
	_ = reflector.SetJSONResponse(&opAIListConfigs, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opAIListConfigs, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opAIListConfigs, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opAIListConfigs, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodGet, "/spaces/{space_ref}/ai", opAIListConfigs)

	opAIAddConfig := openapi3.Operation{}
	opAIAddConfig.WithTags("ai")
	opAIAddConfig.WithSummary("创建AI配置")
	opAIAddConfig.WithMapOfAnything(
		map[string]interface{}{"operationId": "addSpaceAIConfig"})
	_ = reflector.SetRequest(&opAIAddConfig, new(spaceAICreateRequest), http.MethodPost)
	_ = reflector.SetJSONResponse(&opAIAddConfig, new(types.AIConfig), http.StatusOK)
	_ = reflector.SetJSONResponse(&opAIAddConfig, new(usererror.Error), http.StatusBadRequest)
	_ = reflector.SetJSONResponse(&opAIAddConfig, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opAIAddConfig, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opAIAddConfig, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opAIAddConfig, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodPost, "/spaces/{space_ref}/ai", opAIAddConfig)

	opAIUpdateConfig := openapi3.Operation{}
	opAIUpdateConfig.WithTags("ai")
	opAIUpdateConfig.WithSummary("更新AI配置")
	opAIUpdateConfig.WithMapOfAnything(
		map[string]interface{}{"operationId": "updateSpaceAIConfig"})
	_ = reflector.SetRequest(&opAIUpdateConfig, new(spaceAIUpdateRequest), http.MethodPatch)
	_ = reflector.SetJSONResponse(&opAIUpdateConfig, struct{}{}, http.StatusOK)
	_ = reflector.SetJSONResponse(&opAIUpdateConfig, new(usererror.Error), http.StatusBadRequest)
	_ = reflector.SetJSONResponse(&opAIUpdateConfig, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opAIUpdateConfig, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opAIUpdateConfig, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opAIUpdateConfig, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodPatch, "/spaces/{space_ref}/ai/{ai_id}/", opAIUpdateConfig)

	opAIDeleteConfig := openapi3.Operation{}
	opAIDeleteConfig.WithTags("ai")
	opAIDeleteConfig.WithSummary("删除AI配置")
	opAIDeleteConfig.WithMapOfAnything(
		map[string]interface{}{"operationId": "deleteSpaceAIConfig"})
	_ = reflector.SetRequest(&opAIDeleteConfig, new(spaceAIRequest), http.MethodDelete)
	_ = reflector.SetJSONResponse(&opAIDeleteConfig, nil, http.StatusNoContent)
	_ = reflector.SetJSONResponse(&opAIDeleteConfig, new(usererror.Error), http.StatusBadRequest)
	_ = reflector.SetJSONResponse(&opAIDeleteConfig, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opAIDeleteConfig, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opAIDeleteConfig, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opAIDeleteConfig, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodDelete, "/spaces/{space_ref}/ai/{ai_id}/", opAIDeleteConfig)

	opAITestConfig := openapi3.Operation{}
	opAITestConfig.WithTags("ai")
	opAITestConfig.WithSummary("测试AI配置")
	opAITestConfig.WithMapOfAnything(
		map[string]interface{}{"operationId": "testSpaceAIConfig"})
	_ = reflector.SetRequest(&opAITestConfig, new(spaceAIRequest), http.MethodPost)
	_ = reflector.SetJSONResponse(&opAITestConfig, struct{}{}, http.StatusOK)
	_ = reflector.SetJSONResponse(&opAITestConfig, new(usererror.Error), http.StatusBadRequest)
	_ = reflector.SetJSONResponse(&opAITestConfig, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opAITestConfig, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opAITestConfig, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opAITestConfig, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodPost, "/spaces/{space_ref}/ai/{ai_id}/test", opAITestConfig)

	opAISetDefaultConfig := openapi3.Operation{}
	opAISetDefaultConfig.WithTags("ai")
	opAISetDefaultConfig.WithSummary("设置默认AI配置")
	opAISetDefaultConfig.WithMapOfAnything(
		map[string]interface{}{"operationId": "setSpaceDefaultAIConfig"})
	_ = reflector.SetRequest(&opAISetDefaultConfig, new(spaceAIRequest), http.MethodPost)
	_ = reflector.SetJSONResponse(&opAISetDefaultConfig, struct{}{}, http.StatusOK)
	_ = reflector.SetJSONResponse(&opAISetDefaultConfig, new(usererror.Error), http.StatusBadRequest)
	_ = reflector.SetJSONResponse(&opAISetDefaultConfig, new(usererror.Error), http.StatusInternalServerError)
	_ = reflector.SetJSONResponse(&opAISetDefaultConfig, new(usererror.Error), http.StatusUnauthorized)
	_ = reflector.SetJSONResponse(&opAISetDefaultConfig, new(usererror.Error), http.StatusForbidden)
	_ = reflector.SetJSONResponse(&opAISetDefaultConfig, new(usererror.Error), http.StatusNotFound)
	_ = reflector.Spec.AddOperation(http.MethodPost, "/spaces/{space_ref}/ai/{ai_id}/default", opAISetDefaultConfig)
}
