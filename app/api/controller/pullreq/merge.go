...
import (
	...
	"github.com/easysoft/gitfox/contextutil"
...
func (c *Controller) Merge(
	...
	if in.DryRun {
		...
		// 	out.AllowedMethods = []enum.MergeMethod{enum.MergeMethodMerge}
		// }
	...
	if ruleOut.DeleteSourceBranch || pr.Flow == enum.PullRequestFlowZentao {
