...
func HandleAIUpdate(repoSettingCtrl *reposettings.Controller) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		in := new(reposettings.AISettings)
		...
		settings, err := repoSettingCtrl.AIUpdate(ctx, session, repoRef, in)
		if err != nil {
			render.TranslatedUserError(ctx, w, err)
			return
		}
