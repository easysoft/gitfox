...
import (
	...
	middlewareweb "github.com/easysoft/gitfox/app/api/middleware/web"
	...
	"github.com/easysoft/gitfox/web"
...
func NewWebHandler(
	...
	r.HandleFunc("/openapi.yaml", func(w http.ResponseWriter, r *http.Request) {
		...
		spec.Info.Title = "GitFox API"
		spec.Info.Version = common.GetVersionWithHash()
	...
	compress := middleware.Compress(5, "application/javascript", "text/javascript", "text/css")
	r.With(
		sec.Handler,
		compress,
