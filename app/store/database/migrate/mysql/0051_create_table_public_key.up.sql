...
CREATE TABLE public_keys (
 ...
 public_key_principal_id INT NOT NULL,
 ...
 CONSTRAINT fk_public_key_principal_id FOREIGN KEY (public_key_principal_id)
  REFERENCES principals (principal_id) ON UPDATE NO ACTION ON DELETE CASCADE
);

CREATE INDEX public_keys_fingerprint
  ON public_keys(public_key_fingerprint(255));

CREATE UNIQUE INDEX public_keys_principal_id_identifier
  ON public_keys(public_key_principal_id, public_key_identifier(255));
