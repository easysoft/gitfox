...
CREATE TABLE labels (
  ...
  label_space_id INT DEFAULT NULL,
  label_repo_id INT DEFAULT NULL,
  label_scope INT DEFAULT 0,
  label_key VARCHAR(255) NOT NULL,
  label_description VARCHAR(255) NOT NULL DEFAULT '',
  label_color VARCHAR(255) NOT NULL DEFAULT 'black',
  label_type VARCHAR(255) NOT NULL DEFAULT 'static',
  label_created BIGINT NOT NULL,
  label_updated BIGINT NOT NULL,
  label_created_by INT NOT NULL,
  label_updated_by INT NOT NULL,
  label_value_count INT DEFAULT 0,
  ...
  CONSTRAINT chk_label_space_or_repo CHECK (label_space_id IS NULL OR label_repo_id IS NULL),
  ...
  UNIQUE INDEX labels_space_id_key (label_space_id, label_key),
  UNIQUE INDEX labels_repo_id_key (label_repo_id, label_key)
);

--- TODO 改成上面方式
--- CREATE UNIQUE INDEX labels_space_id_key ON labels(label_space_id, label_key) WHERE label_space_id IS NOT NULL;
--- CREATE UNIQUE INDEX labels_repo_id_key ON labels(label_repo_id, label_key) WHERE label_repo_id IS NOT NULL;

CREATE TABLE label_values (
  label_value_id INT AUTO_INCREMENT PRIMARY KEY,
  label_value_label_id INT NOT NULL,
  ...
  label_value_created_by INT NOT NULL,
  label_value_updated_by INT NOT NULL,
...
CREATE UNIQUE INDEX unique_label_value_label_id_value ON label_values(label_value_label_id, label_value_value(255));

CREATE TABLE pullreq_labels (
  pullreq_label_pullreq_id INT NOT NULL,
  pullreq_label_label_id INT NOT NULL,
  pullreq_label_label_value_id INT DEFAULT NULL,
  pullreq_label_created BIGINT NOT NULL,
  pullreq_label_updated BIGINT NOT NULL,
  pullreq_label_created_by INT NOT NULL,
  pullreq_label_updated_by INT NOT NULL,
