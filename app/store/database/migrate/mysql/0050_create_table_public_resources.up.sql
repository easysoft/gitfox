...
DROP TABLE IF EXISTS public_access_repo;
DROP TABLE IF EXISTS public_access_space;
...
INSERT INTO public_access_repo (public_access_repo_id) SELECT repo_id FROM repositories WHERE repo_is_public = 1;

ALTER TABLE repositories DROP COLUMN repo_is_public;

INSERT INTO public_access_space (public_access_space_id) SELECT space_id FROM spaces WHERE space_is_public = 1;
