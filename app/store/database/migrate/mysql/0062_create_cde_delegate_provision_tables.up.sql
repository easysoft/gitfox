...
CREATE TABLE delegate_provision_details (
  dpdeta_id INT AUTO_INCREMENT PRIMARY KEY,
  dpdeta_task_id TEXT NOT NULL,
  dpdeta_action_type TEXT NOT NULL,
  dpdeta_gitspace_instance_id INT NOT NULL,
  dpdeta_space_id INT NOT NULL,
  dpdeta_agent_port INT NOT NULL,
...
CREATE UNIQUE INDEX delegate_provision_details_task_id_space_id ON delegate_provision_details (dpdeta_task_id(255), dpdeta_space_id);
