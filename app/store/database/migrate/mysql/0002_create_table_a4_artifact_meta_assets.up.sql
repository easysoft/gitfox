...
CREATE TABLE artifact_meta_assets (
  meta_asset_id             INTEGER PRIMARY KEY AUTO_INCREMENT,
  meta_asset_owner_id       INTEGER,
  meta_asset_view_id        INTEGER,
  meta_asset_format         VARCHAR(55),
  meta_asset_path           VARCHAR(155),
  meta_asset_content_type   VARCHAR(50),
  meta_asset_kind           VARCHAR(50),
