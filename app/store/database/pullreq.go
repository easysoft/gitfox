...
type pullReq struct {
	...
	RebaseConflicts   null.String           `db:"pullreq_rebase_conflicts"`

	CommitCount null.Int             `db:"pullreq_commit_count"`
	FileCount   null.Int             `db:"pullreq_file_count"`
	Flow        enum.PullRequestFlow `db:"pullreq_flow"`
...
func (s *PullReqStore) SummaryCount(ctx context.Context, opts *types.PullReqSummaryFilter) (*types.PullReqSummary, error) {
	return nil, nil
}
