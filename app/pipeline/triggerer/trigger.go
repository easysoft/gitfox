...
import (
	...
	"github.com/easysoft/gitfox/app/pipeline/checks"
	...
	"github.com/easysoft/gitfox/app/pipeline/triggerer/dag"
	"github.com/easysoft/gitfox/app/services/publicaccess"
	"github.com/easysoft/gitfox/app/store"
	"github.com/easysoft/gitfox/app/url"
	v1yaml "github.com/easysoft/gitfox/internal/pipeline/spec"
	"github.com/easysoft/gitfox/internal/pipeline/spec/parse/normalize"
	specresolver "github.com/easysoft/gitfox/internal/pipeline/spec/parse/resolver"
	...
	"github.com/easysoft/gitfox/pkg/util/yaml/linter"
		...
		for idx, stage := range v.Stages {
			...
			case *v1yaml.StageCI:
				...
				temp := &types.Stage{
					...
					Display:   stage.Name, // record the origin name for display
					Created:   now,
					Updated:   now,
					Status:    status,
					OnSuccess: onSuccess,
