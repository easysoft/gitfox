...
import (
	...
	"github.com/easysoft/gitfox/app/gitspace/orchestrator/git"
	"github.com/easysoft/gitfox/app/gitspace/orchestrator/ide"
	"github.com/easysoft/gitfox/app/gitspace/orchestrator/user"
...
func (e *EmbeddedDockerOrchestrator) startContainer(
	...
	err := dockerClient.ContainerStart(ctx, containerName, dockertype.ContainerStartOptions{})
	if err != nil {
...
func (e *EmbeddedDockerOrchestrator) pullImage(
	...
	pullResponse, err := dockerClient.ImagePull(ctx, imageName, dockertype.ImagePullOptions{})
...
func (e *EmbeddedDockerOrchestrator) containerState(
	...
	containers, err := dockerClient.ContainerList(ctx, dockertype.ContainerListOptions{All: true, Filters: args})
	if err != nil {
...
func (e *EmbeddedDockerOrchestrator) removeContainer(
	...
	err := dockerClient.ContainerRemove(ctx, containerName, dockertype.ContainerRemoveOptions{Force: true})
	if err != nil {
